...
def selectCharacter():
    ...
    player1Naruto = Button(winSelect, text='Naruto', bg='lightgrey', font=("Helvetica", 10), width=15, command=launchGame)
    player1Naruto.place(relx=0.2, rely=0.2)

    player1Sasuke = Button(winSelect, text='Sasuke', bg='lightgrey', font=("Helvetica", 10), width=15, command=launchGame)
    player1Sasuke.place(relx=0.4, rely=0.2)

    player1Itachi = Button(winSelect, text='Itachi', bg='lightgrey', font=("Helvetica", 10), width=15, command=player1Itachi)
